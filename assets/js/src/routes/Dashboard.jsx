...
const mapStateToProps = state => Object.assign({
  ...
  userId: state.userId,
  memeCollected: state.memeCollected
  }, 
  state.position, 
  state.modals
);
  ...
  renderMap() {
    return (
      <Fragment>
        ...
        {this.props.memeCollected ? <p className="dashboard__msg">You have collected a new meme!</p> : null}
